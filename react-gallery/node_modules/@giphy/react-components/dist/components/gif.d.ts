...
declare const Gif: {
    ({ gif, gif: { bottle_data: bottleData }, width, height: forcedHeight, onGifRightClick, className, onGifClick, onGifSeen, onGifVisible, user, backgroundColor, overlay, hideAttribution, noLink, }: Props): JSX.Element;
    className: string;
    imgClassName: string;
};
export default Gif;
